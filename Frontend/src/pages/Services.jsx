...
export default function Services() {
  ...
  return (
    <section className="w-full min-h-screen bg-[#0C0B09] text-[#F4EFE6] font-['Outfit'] flex flex-col justify-center py-20 md:py-28 relative overflow-hidden">
      {/* Soft glow */}
...
function ServiceCard({ icon, index, title, desc, tags }) {
  ...
  return (
    <Reveal width="100%">
      <div className="group relative bg-[#12100D] border border-white/[0.06] p-8 md:p-10 rounded-lg h-full overflow-hidden hover:border-[#D4AF6A]/30 hover:-translate-y-2 transition-all duration-500">
        {/* Hover glow */}
        ...
        <h3 className="font-['Fraunces'] text-2xl md:text-3xl font-semibold mb-4 flex items-center gap-2">
          {title}
