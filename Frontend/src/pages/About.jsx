...
export default function About() {
  return (
    <section className="w-full min-h-screen bg-white text-black flex items-center justify-center py-24 px-10 font-['Outfit']">
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          <Reveal width="100%">
            ...
            <div className="absolute -top-10 -left-10 w-2/3 h-full bg-gray-100 -z-10 rounded-br-[100px]"></div>
            ...
            <a 
                ...
                className="absolute -bottom-10 -left-10 w-24 h-24 bg-white rounded-full flex items-center justify-center animate-spin-slow shadow-lg z-20 cursor-pointer hover:bg-gray-50 transition"
            >
                <div className="relative w-full h-full flex items-center justify-center">
                    <svg className="w-full h-full absolute inset-0 text-black p-1" viewBox="0 0 100 100">
                        <path id="circlePath" d="M 50, 50 m -37, 0 a 37,37 0 1,1 74,0 a 37,37 0 1,1 -74,0" fill="transparent" />
                        <text className="text-[11px] uppercase font-bold tracking-[2px]">
                            <textPath href="#circlePath" startOffset="50%" textAnchor="middle">
                                Download My CV • Download My CV •
                            </textPath>
                        </text>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" className="absolute w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div>
          <Reveal>
            <h4 className="text-gray-500 uppercase tracking-[4px] text-sm font-semibold mb-4">About Me</h4>
            ...
            <div className="grid grid-cols-2 gap-y-6 gap-x-12 text-md mb-12">
                <div>
